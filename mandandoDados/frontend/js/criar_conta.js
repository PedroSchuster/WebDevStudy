...
async function criarConta() {
    ...
    const result = await fetch("http://127.0.0.1:3125/register-user", options);
    const serverResponse = await result.json();
    if (result){
        console.log('Usuario criado com sucesso!')
        console.log(serverResponse.usersList)
        document.getElementById("password-strength").style = "width:0%"
        Array.from(document.getElementsByClassName("status-ok")).forEach(obj=>obj.textContent = '')
        ...
        document.getElementById("cadastro-repitaSenha").value = ''
        document.getElementById("cadastro-cep").value = ''
        document.getElementById("cadastro-logradouro").value = ''
        document.getElementById("cadastro-numero").value = ''
        document.getElementById("cadastro-complemento").value = ''
        document.getElementById("cadastro-bairro").value = ''
        document.getElementById("cadastro-localidade").value = ''
        document.getElementById("cadastro-uf").value = ''
        return
    }
